...
**Полнофункциональное микросервисное приложение с комплексной системой тестирования производительности, включая автоматизацию UI/API тестов, нагрузочное тестирование и детальную аналитику.**

Проект демонстрирует современные подходы к тестированию с использованием:
- **API тестирование**: pytest + Allure Reports
